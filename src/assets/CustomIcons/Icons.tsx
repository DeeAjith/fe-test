...
export const BurgerMenu_Icon = ({
  ...
  return (
    ...
    >
      <rect y="1" width={size} height="2" fill={fill} />
      <rect x="8" y="7" width="8" height="2" fill={fill} />
      <rect y="13" width={size} height="2" fill={fill} />
    </svg>
  )
}
...
export const CheckMark_Icon = ({
  ...
  return (
    ...
    >
      <path
        d="M5.50538 11L0 5.75745L1.05684 4.75106L5.50538 8.98723L14.9432 0L16 1.00638L5.50538 11Z"
        fill={fill}
      />
    </svg>
  )
