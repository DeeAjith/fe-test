...
const RightSection: React.FC<RightSectionProps> = ({
  ...
  <div className="flex flex-col bg-fe-bg-offwhite p-5 pt-10 xl:pt-16 xl:pb-20 md:w-full xl:w-3/5 productRight xl:ps-16 xl:pe-5">
    <p className="flex gap-10 w-[90dvwga md:w-full font-semibold text-fe-gray-text-3 text-xs uppercase tracking-[0.5px] overflow-y-scroll md:overflow-y-auto ] over">
